...
; ModuleID = 'complete_callgraph_4.bc'
source_filename = "../tests/c/complete_callgraph_4.c"
...
; <label>:8:                                      ; preds = %2
  ...
  %11 = getelementptr inbounds %struct.class_t, %struct.class_t* %10, i32 0, i32 2
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define i32 @bar2(%struct.class_t*, i32) #0 {
  %3 = alloca i32, align 4
  %4 = alloca %struct.class_t*, align 8
  %5 = alloca i32, align 4
  store %struct.class_t* %0, %struct.class_t** %4, align 8
...
define i32 @main() #0 {
  ...
  %8 = getelementptr inbounds %struct.class_t, %struct.class_t* %2, i32 0, i32 2
  %9 = bitcast {}** %8 to i32 (%struct.class_t*, i32)**
  store i32 (%struct.class_t*, i32)* @bar2, i32 (%struct.class_t*, i32)** %9, align 8
  %10 = getelementptr inbounds %struct.class_t, %struct.class_t* %2, i32 0, i32 0
  %11 = bitcast {}** %10 to i32 (%struct.class_t*, i32)**
  %12 = load i32 (%struct.class_t*, i32)*, i32 (%struct.class_t*, i32)** %11, align 8
  %13 = call i32 %12(%struct.class_t* %2, i32 42)
  store i32 %13, i32* %3, align 4
  ret i32 0
}
