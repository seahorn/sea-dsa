...
%struct.test_handler = type { %struct.test_sub, ptr }
...
define ptr @return_handler_struct() #0 {
  ...
  %2 = call ptr @malloc(i64 16) #3
  %3 = bitcast ptr %2 to ptr
  store ptr %3, ptr %1, align 8
  %4 = load ptr, ptr %1, align 8
  %5 = getelementptr inbounds %struct.test_handler, ptr %4, i32 0, i32 1
...
define i32 @main(i32 %0, ptr %1) #0 {
  ...
  %9 = call ptr @return_handler_struct()
  store ptr %9, ptr %6, align 8
  %10 = load ptr, ptr %6, align 8
  %11 = bitcast ptr %10 to ptr
  store ptr %11, ptr %7, align 8
  %12 = load ptr, ptr %7, align 8
  %13 = call ptr @to_test_handler(ptr %12)
  store ptr %13, ptr %8, align 8
  %14 = load ptr, ptr %8, align 8
  %15 = getelementptr inbounds %struct.test_handler, ptr %14, i32 0, i32 1
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define internal ptr @to_test_handler(ptr %0) #0 {
