...
entry:
  %v1 = load i16, ptr @g.ptr, align 2
  %ss0 = insertvalue { ptr, i32 } undef, ptr @g.ptr, 0
  %ss1 = insertvalue { ptr, i32 } %ss0, i32 0, 1
  %v2.p = extractvalue { ptr, i32 } %ss0, 0
  %v2 = load i16, ptr %v2.p, align 2
