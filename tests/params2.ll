; RUN: %seadsa %s %cs_dsa --sea-dsa-dot -sea-dsa-stats --sea-dsa-type-aware=true --sea-dsa-dot-outdir=%T/params2.ll
; RUN: %cmp-graphs %tests/params2.entry.mem.dot %T/params2.ll/entry.mem.dot both | OutputCheck %s -d --comment=";"
; CHECK: ^OK$
