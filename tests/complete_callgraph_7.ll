...
; ModuleID = 'complete_callgraph_7.bc'
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define i32 @foo1(i32 (i32, i32)*, i32, i32) #0 {
  %4 = alloca i32 (i32, i32)*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define i32 @foo2(i32 (i32, i32)*, i32, i32) #0 {
  %4 = alloca i32 (i32, i32)*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32 (i32, i32)*, align 8
...
define i32 @main() #0 {
  ...
  %4 = call i32 @foo1(i32 (i32, i32)* @add, i32 2, i32 5)
  store i32 %4, i32* %2, align 4
  %5 = call i32 @foo2(i32 (i32, i32)* @sub, i32 5, i32 7)
