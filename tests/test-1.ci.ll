; RUN: %seadsa  %ci_dsa --sea-dsa-dot %s --sea-dsa-stats --sea-dsa-dot-outdir=%T/test-1.ci.ll
; RUN: %cmp-graphs %tests/test-1.ci.c.main.mem.dot %T/test-1.ci.ll/main.mem.dot | OutputCheck %s -d --comment=";"
; CHECK: ^OK$
