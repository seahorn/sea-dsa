...
; CHECK-L: %sm3 = call i32 @shadow.mem.init(i32 0, ptr null), !shadow.mem !3, !shadow.mem.def !3
; CHECK-L: %sm = call i32 @shadow.mem.store(i32 0, i32 %sm3, ptr null), !shadow.mem !3, !shadow.mem.def !4
; CHECK-L: %sm1 = call i32 @shadow.mem.store(i32 0, i32 %sm, ptr null), !shadow.mem !3, !shadow.mem.def !4
; CHECK-L: %sm2 = call i32 @shadow.mem.store(i32 0, i32 %sm1, ptr null), !shadow.mem !3, !shadow.mem.def !4
; CHECK-L: call void @shadow.mem.load(i32 0, i32 %sm, ptr null), !shadow.mem !3, !shadow.mem.use !4
; CHECK-L: call void @shadow.mem.load(i32 0, i32 %sm1, ptr null), !shadow.mem !3, !shadow.mem.use !4
...
define i32 @main() local_unnamed_addr #0 {
  %1 = tail call ptr @freshInt() #3
  %2 = tail call ptr @freshInt() #3
  tail call void @sea_dsa_alias(ptr %1, ptr %2) #3
...
declare ptr @freshInt() local_unnamed_addr #1

declare void @sea_dsa_alias(ptr, ptr) local_unnamed_addr #1
