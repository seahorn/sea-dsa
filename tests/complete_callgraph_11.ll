...
@arith_functions = common global [4 x ptr] zeroinitializer, align 8
...
define i32 @main() #0 {
  ...
  store ptr @add, ptr @arith_functions, align 8
  store ptr @sub, ptr getelementptr inbounds ([4 x ptr], ptr @arith_functions, i64 0, i64 1), align 8
  store ptr @mul, ptr getelementptr inbounds ([4 x ptr], ptr @arith_functions, i64 0, i64 2), align 8
  store ptr @div, ptr getelementptr inbounds ([4 x ptr], ptr @arith_functions, i64 0, i64 3), align 8
